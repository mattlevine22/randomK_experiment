...
# Set locations
master_file = './raw_data/master_file_2D_16m.pkl' # this is primary raw data from experiments
output_data_dir = './summary_data_2D_16m' # this is output directory for summary data that we build in this script.
...
for key, value in tqdm(iteritems):
    ...
    # update a_dict
    # a_dict[m] : N_Ks x N_dimers x N_targets x N_accesory
    a_dict[m][KID, targetID] = np.squeeze(value['a'])
