...
# Set locations
master_file = './raw_data/master_file_2D.pkl' # this is primary raw data from experiments
output_data_dir = './summary_data_2D' # this is output directory for summary data that we build in this script.
